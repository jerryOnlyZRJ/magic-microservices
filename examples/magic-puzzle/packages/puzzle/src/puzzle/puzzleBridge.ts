import { EventType, IClientWindow } from '@byted-cg/open-source-portal';
import { getHash } from '@byted-cg/open-source-portal-utils';
...
const handlePuzzleCallback = (callback: PuzzleEventListener, type: string) => (
  e: MessageEvent,
): void => {
